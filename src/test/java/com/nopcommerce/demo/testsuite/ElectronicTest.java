...
public class ElectronicTest extends BaseTest {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        registerPage.sendTextToFirstNameField("Terry");
        registerPage.sendTextToLastNameField("Bobby");
        registerPage.selectDayOfBirth("15");
        registerPage.selectDayOfMonth("5");
        registerPage.selectDayOfYear("1970");
        registerPage.sendTextToEmailField("terry");
        registerPage.sendTextToPasswordField("pass123");
        registerPage.sendTextToConfirmPasswordField("pass123");
        ...
        checkOutPage.sendTextToAddressField("Oxford Street");
        checkOutPage.sendTextToPostCodeField("SE1 8NH");
        checkOutPage.sendTextToPhoneField("09885155448845");
        ...
        checkOutPage.sendTextToCardholderNameField("TBobby");
        ...
        checkOutPage.sendTextToCardCodeField("893");
